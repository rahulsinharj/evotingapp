...
public class AddVoteControllerServlet extends HttpServlet {
 ...
 System.out.println("In the AddVoteControllerServlet");
 ...
 System.out.println("candidateid in AddVoteControllerServlet [cid]: "+cid);
 System.out.println("candidateid in AddVoteControllerServlet [userid] "+userid);
      ...
      {  
            boolean result;
            if(VoteDao.getCandidateId(userid)!=null)                  // vote de chuka hoga
            {   
                result=false;
            }
            else 
