...
<html>
    ...
    <body>
        <%
           ...
           System.out.println("In [VotingResponse] voterUserId: "+userid);
            if(userid==null)
            {
                 session.invalidate();
            ...
            {
           String cid=VoteDao.getCandidateId(userid);  // AddVoteControllerServlet me already voterid, cid ke saath DB me chala gya hai.
           System.out.println("Voted Candidate: "+cid);
