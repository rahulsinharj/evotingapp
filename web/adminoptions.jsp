...
<html>
    ...
    <body>
        <%
            String userid=(String)session.getAttribute("userid");  // this line will validate the sessionId user to restrict unAuthorize accss.
            if(userid==null)
            {
        ...
        "<div class='subcandidate'>Admin Actions Page</div><br><br>"+
            ...
            out.println(displayBlock);   //  "out" is used to SHOW these clickable images in the web page. 
        %>
    </body>
</html>
